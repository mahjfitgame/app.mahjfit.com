...
-- Source: entity.ts files
-- Do not edit manually
-- --------------------------------------------------

-- --------------------------------------------------
-- .tmp/drizzle-public-schema/drizzle/0000_public-schema.sql
-- --------------------------------------------------
...
--> statement-breakpoint
CREATE INDEX `in_sync_queue_operation` ON `te_sync_queue` (`syq_operation`);--> statement-breakpoint
...
-- --------------------------------------------------
-- file: public/db/schema.static.sql
