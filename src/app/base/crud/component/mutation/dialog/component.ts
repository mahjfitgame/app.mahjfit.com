...
@Component({
  selector: 'crud-mutation-dialog-component',
  standalone: true,
...
export class CrudMutationDialogComponent {
  public readonly service = inject(CrudService);
  private readonly dialogRef = inject(MatDialogRef<CrudMutationDialogComponent>);
}
