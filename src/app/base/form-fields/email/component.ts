// file: src/app/base/form-fields/email/component.ts
...
import { FormFieldEmailService } from '@base/form-fields/email/service';
...
@Component({
    ...
    providers: [
        FormFieldEmailState,
        FormFieldEmailService,
    ],
})
export class FormFieldEmailComponent {
    public readonly service = inject(FormFieldEmailService);
    ...
    /** 'alternate_email' when unset - the fallback lives in the template, not here */
