// file: src/app/base/form-fields/tel/state.ts
import { computed, Service, signal } from '@angular/core';
import { FormFieldTelConfigType } from '@base/form-fields/tel/type';
...
export class FormFieldTelState {

    // ████ SIGNAL PROPERTIES ███████████████████████████████████████████

    private readonly _config = signal<FormFieldTelConfigType | null>(null);
    ...
    public bind(config: FormFieldTelConfigType): void {
