// file: src/app/module/shared/onboarding/recover-password/component.ts

import { Component, inject, OnInit, input, effect } from '@angular/core';
...
export class RecoverPasswordComponent implements OnInit {
    public readonly publicid = input<string>();

    protected readonly service = inject(RecoverPasswordService);

    constructor() {
        effect(() => {
            this.service.state.setPublicid(this.publicid());
        });
    }
