// file: src/app/module/shared/onboarding/recover-password/slug.ts
...
// sub slug(s)
export const SLUG_RECOVER_PASSWORD_PUBLICID: string = `${SLUG_RECOVER_PASSWORD}/:${SLUG_FOUNDATION_MODULE_PARAM_PUBLICID}` as const;