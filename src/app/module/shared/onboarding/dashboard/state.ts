// file: src/app/module/shared/onboarding/dashboard/state.ts
...
import { ONBOARDING_DASHBOARD_STATE_STORE_KEY } from "./const";

@Service({ autoProvided: false })
export class DashboardState extends SignalStateService implements FoundationModuleStateType {
    ...
    public override readonly storeKey = ONBOARDING_DASHBOARD_STATE_STORE_KEY;
