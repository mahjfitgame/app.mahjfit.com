// file: src/app/module/shared/onboarding/signup/state.ts
...
import { SignupMutationFieldObjType, SignupMutationFormErrorType, SignupMutationFormModelType } from "@module/shared/onboarding/signup/type";
import { CrudChildMutationStateType } from "src/app/base/crud/child/type/mutation.state";
import { ONBOARDING_SIGNUP_STATE_STORE_KEY } from "./const";
...
export class SignupState extends SignalStateService implements FoundationModuleStateType, CrudChildMutationStateType {
    ...
    public override readonly storeKey = ONBOARDING_SIGNUP_STATE_STORE_KEY;
    ...
    public readonly MUTATION_FIELD_OBJ: SignupMutationFieldObjType = {
        arole_id: {
            ...
            label: 'ONBOARDING_SIGNUP.FIELD_LABEL.AROLE_ID',
            placeholder: 'ONBOARDING_SIGNUP.FIELD_PLACEHOLDER.AROLE_ID',
            hint: '',
            url_matrix_param: 'ar',
            value: null,
            validation: {
                required: {
                    message: 'ONBOARDING_SIGNUP.VALIDATION.AROLE_ID',
                    value: true,
                }
            }
        },
        connsrc_id: {
            type: CrudFieldUiTypeEnum.SELECT,
            label: 'ONBOARDING_SIGNUP.FIELD_LABEL.CONNSRC_ID',
            placeholder: 'ONBOARDING_SIGNUP.FIELD_PLACEHOLDER.CONNSRC_ID',
            hint: '',
            url_matrix_param: 'cs',
            value: null,
            validation: {
                required: {
                    message: 'ONBOARDING_SIGNUP.VALIDATION.CONNSRC_ID',
                    value: true,
                }
            }
        },
        identify: {
            ...
            label: 'ONBOARDING_SIGNUP.FIELD_LABEL.IDENTIFY',
            placeholder: 'ONBOARDING_SIGNUP.FIELD_PLACEHOLDER.IDENTIFY',
            hint: '',
            url_matrix_param: 'i',
            value: null,
            validation: {
                required: {
                    message: 'ONBOARDING_SIGNUP.VALIDATION.IDENTIFY',
                    value: true,
                },
                min_length: {
                    message: 'ONBOARDING_SIGNUP.VALIDATION.IDENTIFY_MIN_LENGTH',
                    value: 8,
                },
                pattern: {
                    message: 'ONBOARDING_SIGNUP.VALIDATION.IDENTIFY_PATTERN',
        ...
        identify_confirm: {
            type: CrudFieldUiTypeEnum.PASSWORD,
            label: 'ONBOARDING_SIGNUP.FIELD_LABEL.IDENTIFY_CONFIRM',
            placeholder: 'ONBOARDING_SIGNUP.FIELD_PLACEHOLDER.IDENTIFY_CONFIRM',
            hint: '',
            url_matrix_param: 'ic',
            value: null,
            validation: {
                required: {
                    message: 'ONBOARDING_SIGNUP.VALIDATION.IDENTIFY_CONFIRM',
                    value: true,
                },
                min_length: {
                    message: 'ONBOARDING_SIGNUP.VALIDATION.IDENTIFY_MIN_LENGTH',
                ...
                match_field: {
                    message: 'ONBOARDING_SIGNUP.VALIDATION.IDENTIFY_MISMATCH',
                    value: 'identify',
                }
            }
        },
        primary_email: {
            ...
            label: 'ONBOARDING_SIGNUP.FIELD_LABEL.PRIMARY_EMAIL',
            placeholder: 'ONBOARDING_SIGNUP.FIELD_PLACEHOLDER.PRIMARY_EMAIL',
            hint: '',
            url_matrix_param: 'pe',
            value: null,
            validation: {
                required: {
                    message: 'ONBOARDING_SIGNUP.VALIDATION.PRIMARY_EMAIL',
                    value: true,
                },
                email: {
                    message: 'ONBOARDING_SIGNUP.VALIDATION.PRIMARY_EMAIL_FORMAT',
                    value: true,
                }
            }
        },
        primary_mobile: {
            ...
            label: 'ONBOARDING_SIGNUP.FIELD_LABEL.PRIMARY_MOBILE',
            placeholder: 'ONBOARDING_SIGNUP.FIELD_PLACEHOLDER.PRIMARY_MOBILE',
            hint: '',
            url_matrix_param: 'pm',
            value: null,
            validation: {
                required: {
                    message: 'ONBOARDING_SIGNUP.VALIDATION.PRIMARY_MOBILE',
                    value: true,
                },
                max_length: {
                    message: 'ONBOARDING_SIGNUP.VALIDATION.PRIMARY_MOBILE_MAX_LENGTH',
                    value: 15,
                }
            }
        },
        primary_mobile_cc: {
            type: CrudFieldUiTypeEnum.SELECT,
            label: 'ONBOARDING_SIGNUP.FIELD_LABEL.PRIMARY_MOBILE_CC',
            placeholder: 'ONBOARDING_SIGNUP.FIELD_PLACEHOLDER.PRIMARY_MOBILE_CC',
            hint: '',
            url_matrix_param: 'pmcc',
            value: null,
            validation: {
                required: {
                    message: 'ONBOARDING_SIGNUP.VALIDATION.PRIMARY_MOBILE_CC',
                    value: true,
                },
                max_length: {
                    message: 'ONBOARDING_SIGNUP.VALIDATION.PRIMARY_MOBILE_CC_MAX_LENGTH',
                    value: 4,
                }
            }
        },
        username: {
            ...
            label: 'ONBOARDING_SIGNUP.FIELD_LABEL.USERNAME',
            placeholder: 'ONBOARDING_SIGNUP.FIELD_PLACEHOLDER.USERNAME',
            hint: '',
            url_matrix_param: 'un',
            value: null,
            validation: {
                min_length: {
                    message: 'ONBOARDING_SIGNUP.VALIDATION.USERNAME_MIN_LENGTH',
                    value: 4,
                }
            }
        },
