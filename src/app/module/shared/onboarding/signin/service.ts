...
import { AppStepSigninInputDto, AppStepSigninUserOutputDto, AppStepSigninUserOutputSelectionSchema, AuthorisationRoleEnum, SigninStepEnum, StepSigninSubProcessEnum, UserAuthentication, UserMultiFactorAuthenticationTypeEnum, UserMultiFactorAuthenticationTypeEnumAddon } from "@bfw/api-sdk/graphql/endpoints/shared";
...
export class SigninService implements AppModuleServiceType {
