// file: src/app/module/shared/onboarding/my-profile/state.ts
...
import { ONBOARDING_MY_PROFILE_STATE_STORE_KEY } from "./const";

@Service({ autoProvided: false })
export class MyProfileState extends SignalStateService implements FoundationModuleStateType {
    ...
    public override readonly storeKey = ONBOARDING_MY_PROFILE_STATE_STORE_KEY;
