// file: src/app/module/shared/preboarding/signin/state.ts
import { computed, effect, inject, Service, signal } from "@angular/core";
import { ConfService } from "@libs/conf/service";
import { LogService } from "@libs/log/service";
import { SignalStateService } from "@libs/signal-state/service";
import { SigninMutationFormModelType, SigninStepResponseType, SigninMutationFieldObjType, SigninStepSequenceType, SigninAvailableMultiFactorAuthenticationType, SigninMutationFormErrorType } from "@module/shared/preboarding/signin/type";
...
export class SigninState extends SignalStateService implements FoundationModuleStateType, CrudChildMutationStateType {
    ...
    public readonly MUTATION_FIELD_OBJ: SigninMutationFieldObjType = {
        un_pe_pm: {
            ...
            label: 'PREBOARDING_SIGNIN.FIELD_LABEL.USERNAME',
            placeholder: 'PREBOARDING_SIGNIN.FIELD_PLACEHOLDER.USERNAME',
            hint: '',
        ...
        identify: {
            ...
            label: 'PREBOARDING_SIGNIN.FIELD_LABEL.PASSWORD',
            placeholder: 'PREBOARDING_SIGNIN.FIELD_PLACEHOLDER.PASSWORD',
            hint: '',
            url_matrix_param: 'i',
            value: null,
            validation: {
        ...
        keep_logged: {
            ...
            label: 'PREBOARDING_SIGNIN.FIELD_LABEL.KEEP_SIGNED_IN',
            placeholder: '',
            hint: '',
            url_matrix_param: 'kl',
            value: null,
        ...
        mfa_option: {
            ...
            label: 'PREBOARDING_SIGNIN.FIELD_LABEL.MFA_OPTION',
            placeholder: '',
            hint: '',
            url_matrix_param: 'mo',
            value: null,
        ...
        mfa_vi: {
            type: CrudFieldUiTypeEnum.TEXT,
            label: 'PREBOARDING_SIGNIN.FIELD_LABEL.OTP',
            placeholder: 'PREBOARDING_SIGNIN.FIELD_PLACEHOLDER.OTP',
            hint: '',
            url_matrix_param: 'vi',
            value: null,
            validation: {
