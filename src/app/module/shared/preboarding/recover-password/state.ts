// file: src/app/module/shared/preboarding/recover-password/state.ts
...
} from 'src/app/module/shared/preboarding/recover-password/type';
...
export class RecoverPasswordState extends SignalStateService implements FoundationModuleStateType, CrudChildStateType, CrudMutationStateType {
    ...
    public override readonly storeKey = PREBOARDING_RECOVERPASSWORD_STATE_STORE_KEY;
    ...
    public readonly MUTATION_FIELD_OBJ: RecoverPasswordMutationFieldObjType = {
        un_pe_pm: {
            ...
            label: 'PREBOARDING_RECOVERPASSWORD.FIELD_LABEL.USERNAME',
            placeholder: 'PREBOARDING_RECOVERPASSWORD.FIELD_PLACEHOLDER.USERNAME',
            hint: '',
            url_matrix_param: 'uem',
            value: null,
            validation: {
                required: {
                    message: 'PREBOARDING_RECOVERPASSWORD.VALIDATION.USERNAME',
                    value: true,
                },
                min_length: {
                    message: 'PREBOARDING_RECOVERPASSWORD.VALIDATION.USERNAME_MIN_LENGTH',
                    value: 4,
                },
            },
        },
        identify: {
            ...
            label: 'PREBOARDING_RECOVERPASSWORD.FIELD_LABEL.IDENTIFY',
            placeholder: 'PREBOARDING_RECOVERPASSWORD.FIELD_PLACEHOLDER.IDENTIFY',
            hint: '',
            url_matrix_param: 'i',
            value: null,
            validation: {
                required: {
                    message: 'PREBOARDING_RECOVERPASSWORD.VALIDATION.IDENTIFY',
                    value: true,
                },
                min_length: {
                    message: 'PREBOARDING_RECOVERPASSWORD.VALIDATION.IDENTIFY_MIN_LENGTH',
                    value: 8,
                },
                pattern: {
                    message: 'PREBOARDING_RECOVERPASSWORD.VALIDATION.IDENTIFY_PATTERN',
        ...
        identify_confirm: {
            type: CrudFieldUiTypeEnum.PASSWORD,
            label: 'PREBOARDING_RECOVERPASSWORD.FIELD_LABEL.IDENTIFY_CONFIRM',
            placeholder: 'PREBOARDING_RECOVERPASSWORD.FIELD_PLACEHOLDER.IDENTIFY_CONFIRM',
            hint: '',
            url_matrix_param: 'ic',
            value: null,
            validation: {
                required: {
                    message: 'PREBOARDING_RECOVERPASSWORD.VALIDATION.IDENTIFY_CONFIRM',
                    value: true,
                },
                min_length: {
                    message: 'PREBOARDING_RECOVERPASSWORD.VALIDATION.IDENTIFY_MIN_LENGTH',
                ...
                match_field: {
                    message: 'PREBOARDING_RECOVERPASSWORD.VALIDATION.IDENTIFY_MISMATCH',
                    value: 'identify',
                },
            },
        },
        pass_recover_token: {
            ...
            label: 'PREBOARDING_RECOVERPASSWORD.FIELD_LABEL.PASS_RECOVER_TOKEN',
            placeholder: 'PREBOARDING_RECOVERPASSWORD.FIELD_PLACEHOLDER.PASS_RECOVER_TOKEN',
            hint: 'PREBOARDING_RECOVERPASSWORD.HINT.PASS_RECOVER_TOKEN',
            url_matrix_param: 'prt',
            value: null,
            validation: {
                required: {
                    message: 'PREBOARDING_RECOVERPASSWORD.VALIDATION.PASS_RECOVER_TOKEN',
                    value: true,
                },
            },
        },
