// file: src/app/module/shared/preboarding/forgot-password/service.ts
...
import { PREBOARDING_FORGOTPASSWORD_I18N_KEY } from "src/app/module/shared/preboarding/forgot-password/const";
...
export class ForgotPasswordService implements FoundationModuleServiceType {
    ...
    public initI18n(): void {
        this.i18n.useModule(PREBOARDING_FORGOTPASSWORD_I18N_KEY);
    }
            ...
            try {
                ...
                const message = error instanceof BfwApiSdkError
                    ...
                    : error instanceof Error
                        ? error.message
                        : this.i18n.translate('PREBOARDING_FORGOTPASSWORD.MESSAGE.ERROR');
