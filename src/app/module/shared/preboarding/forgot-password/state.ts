// file: src/app/module/shared/preboarding/forgot-password/state.ts
...
export class ForgotPasswordState extends SignalStateService implements FoundationModuleStateType, CrudChildStateType, CrudMutationStateType {
    ...
    public override readonly storeKey = PREBOARDING_FORGOTPASSWORD_STATE_STORE_KEY;
    ...
    public readonly MUTATION_FIELD_OBJ: ForgotPasswordMutationFieldObjType = {
        un_pe_pm: {
            ...
            label: 'PREBOARDING_FORGOTPASSWORD.FIELD_LABEL.USERNAME',
            placeholder: 'PREBOARDING_FORGOTPASSWORD.FIELD_PLACEHOLDER.USERNAME',
            hint: '',
            url_matrix_param: 'uem',
            value: null,
            validation: {
                required: {
                    message: 'PREBOARDING_FORGOTPASSWORD.VALIDATION.USERNAME',
                    value: true,
                },
                min_length: {
                    message: 'PREBOARDING_FORGOTPASSWORD.VALIDATION.USERNAME_MIN_LENGTH',
                    value: 4,
                }
            }
        },
        arole_id: {
            ...
            label: 'PREBOARDING_FORGOTPASSWORD.FIELD_LABEL.AROLE_ID',
            placeholder: 'PREBOARDING_FORGOTPASSWORD.FIELD_PLACEHOLDER.AROLE_ID',
            hint: '',
            url_matrix_param: 'ar',
            value: null,
            validation: {
                required: { 
                    message: 'PREBOARDING_FORGOTPASSWORD.VALIDATION.AROLE_ID',
                    value: true,
                }
            }
        },
        pass_recover_url: {
            ...
            label: 'PREBOARDING_FORGOTPASSWORD.FIELD_LABEL.PASS_RECOVER_URL',
            placeholder: 'PREBOARDING_FORGOTPASSWORD.FIELD_PLACEHOLDER.PASS_RECOVER_URL',
            hint: '',
            url_matrix_param: 'pru',
            value: null,
            validation: {
                required: {
                    message: 'PREBOARDING_FORGOTPASSWORD.VALIDATION.PASS_RECOVER_URL',
                    value: true,
                }
            }
        },
