// file: src/app/module/shared/geo/state/state.ts
...
import { GEO_STATE_STATE_STORE_KEY } from "./const";

@Service({ autoProvided: false })
export class GeoStateState extends SignalStateService implements FoundationModuleStateType {
    ...
    public override readonly storeKey = GEO_STATE_STATE_STORE_KEY;
