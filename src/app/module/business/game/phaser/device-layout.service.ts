...
type NativeOrientation = ScreenOrientationResult["type"];
...
export function resolveDeviceLayout(width: number, height: number): DeviceLayout {
...
export class DeviceLayoutService implements OnDestroy {
  ...
  forViewport(width: number, height: number): DeviceLayoutState {
    ...
    return {
      ...
      layout: resolveDeviceLayout(normalizedWidth, normalizedHeight),
    };
  }
